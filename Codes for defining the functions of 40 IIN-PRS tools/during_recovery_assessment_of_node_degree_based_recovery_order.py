...
def during_recovery_assessment_of_node_degree_based_recovery_order(global_json_path):
    """
    ...
    with open(global_json_path, 'r') as file:
        ...
        recovery_strategy_path = file_paths.get('recovery_order_determined_based_on_node_degree')
    ...
    output_json_path = 'during_recovery_assessment_of_node_degree_based_recovery_order.json'
    with open(output_json_path, 'w') as outfile:
        json.dump(result, outfile, indent=4)

    # Update the Global_Data.json file with the new recovery strategy result path
    file_paths['during_recovery_assessment_of_node_degree_based_recovery_order'] = output_json_path
...
during_recovery_assessment_of_node_degree_based_recovery_order(global_json_path)
