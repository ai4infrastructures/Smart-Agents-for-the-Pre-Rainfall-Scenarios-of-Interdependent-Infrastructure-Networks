...
def failure_node_extractor_for_HECRAS_simulations(global_json_path):
    ...
    rainfall_json_path = file_paths['one_hundred_year_rainfall_event']
...
''')
    ...
    try:
        ...
        print("The HEC-RAS controller was loaded successfully！")
    except Exception as e:
        print(f"The loading of the HEC-RAS controller failed: {e}")
        exit()
