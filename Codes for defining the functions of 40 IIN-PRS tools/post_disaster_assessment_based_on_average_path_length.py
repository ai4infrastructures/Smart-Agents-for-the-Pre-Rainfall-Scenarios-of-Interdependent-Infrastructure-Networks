...
def post_disaster_assessment_based_on_average_path_length(global_json_path: str):
    ...
    output_json_path = 'post_disaster_assessment_based_on_average_path_length.json'
    ...
    file_paths['post_disaster_assessment_based_on_average_path_length'] = output_json_path
...
post_disaster_assessment_based_on_average_path_length(global_json_path)
