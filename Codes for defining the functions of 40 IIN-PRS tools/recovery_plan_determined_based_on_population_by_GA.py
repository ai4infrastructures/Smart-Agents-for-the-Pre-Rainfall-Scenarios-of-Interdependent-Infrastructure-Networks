...
def recovery_plan_determined_based_on_population_by_GA(global_json_path):
    ...
    cascading_failure_path = global_data["cascade_failure_simulator_based_on_Motter_Lai_model"]
    ...
    output_json_path = 'recovery_plan_determined_based_on_population_by_GA.json'
    with open(output_json_path, 'w') as f:
        json.dump(daily_recovery_order, f, indent=4)

    global_data["recovery_plan_determined_based_on_population_by_GA"] = output_json_path
...
recovery_plan_determined_based_on_population_by_GA(global_json_path)
