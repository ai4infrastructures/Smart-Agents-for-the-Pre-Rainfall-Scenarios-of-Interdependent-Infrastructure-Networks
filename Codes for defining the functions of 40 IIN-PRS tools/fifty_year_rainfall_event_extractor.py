...
def fifty_year_rainfall_event_extractor(global_json_path):
    # 定义输出文件名称
    output_path = "fifty_year_rainfall_event.json"
    ...
    global_data["fifty_year_rainfall_event"] = output_path
...
fifty_year_rainfall_event_extractor(global_json_path)
