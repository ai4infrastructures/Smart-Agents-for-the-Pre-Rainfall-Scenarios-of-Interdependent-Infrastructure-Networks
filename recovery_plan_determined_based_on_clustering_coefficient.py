...
def recovery_plan_determined_based_on_clustering_coefficient(global_json_path):
    ...
    failed_nodes = cascading_failure_data['all_failed_nodes']
    ...
    output_json_path = 'recovery_plan_determined_based_on_clustering_coefficient.json'
    with open(output_json_path, 'w') as f:
        json.dump(recovery_data, f, indent=4)

    global_data["recovery_plan_determined_based_on_clustering_coefficient"] = output_json_path
...
recovery_plan_determined_based_on_clustering_coefficient(global_json_path)